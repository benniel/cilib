 ...
 */
public final class NonStochasticVelocityProvider implements VelocityProvider {
    ...
    public NonStochasticVelocityProvider() {
        this(ConstantControlParameter.of(0.729844),
            ConstantControlParameter.of(1.496180),
            ConstantControlParameter.of(1.496180));
    }

    public NonStochasticVelocityProvider(ControlParameter inertia, ControlParameter social, ControlParameter cog) {
     ...
     */
    public NonStochasticVelocityProvider(NonStochasticVelocityProvider copy) {
     ...
     */
    @Override
    public NonStochasticVelocityProvider getClone() {
        return new NonStochasticVelocityProvider(this);
    }
    ...
    public Vector get(Particle particle) {
        ...
        Vector cognitiveComponent = Vector.copyOf(localGuide).subtract(position).multiply(cp(cognitiveAcceleration));
        Vector socialComponent = Vector.copyOf(globalGuide).subtract(position).multiply(cp(socialAcceleration));
