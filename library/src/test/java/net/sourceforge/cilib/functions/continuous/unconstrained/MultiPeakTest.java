...
public class MultiPeakTest {

    private ContinuousFunction function;

    @Before
    public void instantiate() {
        this.function = new MultiPeak();
    }
    ...
    public void plot() {
        ...
        File f = new File("/home/bennie/Research/cilib_AM/Convergence/MovingPeaks/plots/MultiPeakLandscape.in");
